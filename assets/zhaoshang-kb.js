...
(function () {
  ...
  // 招商正文结构参考范文（口吻/骨架，生成时原创改写、不照抄；已去掉收费/知识付费等违禁内容）
  const REF_STRUCT = '【正文结构参考范文·招商正文就照这个结构和口吻写（原创改写、别照抄字句）】开头共情（「我相信很多姐妹想做珠宝，但都不敢大胆迈出第一步、不会入门怕亏本，那我先介绍一下」）→ 编号 ①②③④ 分点：①有自己的珠宝供应链、明码标价品类齐全、每天上架几百件、想拓展线上；②主营彩宝/翡翠/珍珠/精品水晶/银饰，知识库完善＋AI 工具帮你轻松上手；③受众广复购高（高中生/大学生/上班族/宝妈/长辈/线下商家/送礼都来挑、什么价位都有、基本回头客）；④朋友圈有个小圈子就能开单、货盘大可不断试品类；最后重点强调 0库存0成本·无租金压力·不用囤货开店·放心卖 → 结尾「机会永远留给敢迈出第一步的人」→ 话题标签（#彩宝供应链 #珠宝供应链 #珠宝创业 #副业 #轻创业）。口吻真诚像朋友唠嗑，别端着别营销腔。';
  // 抓不到真实正文时的兜底（标题提炼的招商套路）
  const BASE = '【招商/招代理题材·全品类珠宝代理（彩宝/翡翠/珍珠/精品水晶/银饰都做，别只说彩宝）·口吻像朋友真诚唠嗑、亲和不端着、别营销腔】\n① 痛点共情：很多姐妹想做珠宝但不敢迈第一步、怕不会入门、怕亏本囤货——先接住再讲。\n② 供应链底气：自有珠宝供应链、明码标价、品类齐全、每天上架几百件，货盘大、可不断试出适合自己的品类。\n③ 上手轻松：知识库完善 + 结合 AI 工具帮你快速上手，小白也能做；图片文案都备好，你只管发圈。\n④ 受众广复购高：高中生/大学生/上班族/宝妈/长辈/线下门店商家/送礼人群都有，什么价位都有、基本回头客；朋友圈有小圈子就能开单。\n⑤ 最核心卖点：0库存0成本、无租金压力、不用囤货不用开店，放心卖。\n⑥ 真实体验钩子：第一次做全品类珠宝代理真的嘎嘎香 / 珠宝创业别着急开店 / 轻投入入门 / 无压货珠宝创业。\n'+REF_STRUCT+'\n〔招商合规铁律〕只讲供应链优势/合作模式/真实体验；绝不承诺具体收入或"稳赚/月入过万/躺赚"，绝不提及代理费/加盟费/入门费/门槛费/押金/知识付费/收费/交钱/一顿饭钱等任何“向代理收取费用/需先交钱”的字眼（只讲0库存0成本合作与货源支持，收费相关一律不写）；不用拉人头·发展下线·多级返利等传销话术，如实提示"收益因人而异"。';
  ...
  function kb() { const c = cached(); const core = c ? c.kb : BASE; return core.indexOf('结构参考范文') >= 0 ? core : (core + '\n\n' + REF_STRUCT); }
